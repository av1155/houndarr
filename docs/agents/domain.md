...
- **`docs/adr/`**: read ADRs that touch the area you're about to work
  in. In multi-context repos, also check `src/<context>/docs/adr/` for
...
Houndarr is a **single-context** repo. When `CONTEXT.md` and
`docs/adr/` exist, they live at the repo root:
...
> _Contradicts ADR-0007 (event-sourced orders): worth reopening
> because..._
